...
<head>
    ...
    <title>@yield('title', 'Photography Studio') - Professional Photography Services</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="{{ route('home') }}">
                <i class="fas fa-camera"></i> Photography Studio
            </a>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="{{ route('services.index') }}" class="text-white-50 text-decoration-none">Services</a></li>
                        <li><a href="mailto:contact@photography.com" class="text-white-50 text-decoration-none">Contact</a></li>
                    </ul>
                </div>
                <div class="col-md-4">
                    <h5>Contact</h5>
                    <p>Email: info@photography.com<br>Phone: (555) 123-4567</p>
                </div>
            </div>
